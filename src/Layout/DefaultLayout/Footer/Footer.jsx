        ...
        <div className="bg-footer pt-20 text-white pb-0 leading-6 mb-0 flex flex-col px-28">
            <div className="flex justify-between items-center">
                ...
                <div className="flex flex-col">
                    ...
                    <Link to={'/chinh-sach-bao-hanh-bao-tri'} className="my-4 hover:text-blue-300">
                        Chính sách vận chuyển
                    </Link>
                    <Link to={'/chinh-sach-doi-tra-hang-va-hoan-tien'} className="my-4 hover:text-blue-300">
                        Đổi/trả hàng
                    </Link>
                    <Link to={'/chinh-sach-bao-mat-thong-tin-ca-nhan'} className="my-4 hover:text-blue-300">
                        Bảo mật thông tin
                    </Link>
                </div>
